...
(function (global, factory) {
  ...
  ParsleyValidatorRegistry.prototype = {
    ...
    addValidator: function addValidator(name, arg1, arg2) {
      if (this.validators[name]) ParsleyUtils__default.warn('Validator "' + name + '" já está definido.');else if (ParsleyDefaults.hasOwnProperty(name)) {
        ParsleyUtils__default.warn('"' + name + '" é uma palavra-chave restrita e não é um nome de validador válido.');
        return;
      }
    ...
    updateValidator: function updateValidator(name, arg1, arg2) {
      if (!this.validators[name]) {
        ParsleyUtils__default.warn('Validator "' + name + '" ainda não está definido.');
    ...
    removeValidator: function removeValidator(name) {
      if (!this.validators[name]) ParsleyUtils__default.warn('Validator "' + name + '" não está definido.');
  ...
  Parsley.addMessages('pt-br', {
    ...
    range: "Esse valor deve estar entre% s e% s.",
    minlength: "Esse valor é muito curto. Deve ter caracteres de% s ou mais.",
    maxlength: "Esse valor é muito longo. Ele deve ter caracteres de% s ou menos.",
    length: "Esse valor é inválido. Deve estar entre os caracteres% s e% s longos.",
