					...
					<div class="x_panel">
						<div class="x_content">
							<form class="form-horizontal form-label-left"
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Companhia
										ID</label>
									<div class="col-xs-3">
										<input type="text" class="textfield form-control"
											id="companhiaID" name="companhiaID"
											value="${servico.companhiaID}"
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<textarea class="resizable_textarea form-control"
											placeholder="" name="descricao">${servico.descricao}</textarea>
									</div>
								</div>
