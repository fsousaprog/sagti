									...
									<div class="x_content">
										...
										<form id="form-control" action="/atualizarProblema"
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">Fase<span
													class="required">*</span>
												</label>
												<div class="col-xs-3">
													<input type="text" id="fase" name="fase"
														required="required" value="${erro.fase}"
														class="form-control col-md-7 col-xs-12">
												</div>
											</div>

											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">Responsável
													ID</label>
												<div class="col-xs-3">
													<input type="text" class="textfield form-control"
														id="responsavelID" name="responsavelID"
														value="${erro.responsavelID}"
											...
											<div class="form-group">
												...
												<div class="col-xs-6">
													<textarea class="resizable_textarea form-control"
														placeholder="">${erro.causaRaiz}</textarea>
												</div>
											</div>

											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-3">Previsão
													Solução</label>
												<div class="col-xs-5 date">
													<div class="col-xs-4">
														<input type="text" class="form-control"
															name="previsaoSolucao" value="${erro.previsaoSolucao}"
											...
											<div class="form-group">
												<c:if test="${erro.erroConhecido == 'true'}">
													<c:set var="sim" value="checked" />
													<c:set var="nao" value="" />
												</c:if>
												<c:if test="${erro.erroConhecido == 'false'}">
													<c:set var="sim" value="" />
													<c:set var="nao" value="checked" />
												</c:if>
												<label class="control-label col-md-3 col-sm-3 col-xs-3">
													Erro conhecido</label> <label class="radio-inline"> <input
													id="erroConhecido" name="erroConhecido" value="true"
													checked="${sim}" type="radio">Sim
												</label> <label class="radio-inline"> <input
													checked="${nao}" id="erroConhecido" name="erroConhecido"
													value="false" type="radio">Não
												</label>
											</div>
